...
print("__________NIGERIA__________")
listas_concretas('Nigeria')
print("__________SPAIN__________")
listas_concretas('Spain')
print("__________KYRGYZ REPUBLIC__________")
listas_concretas('Kyrgyz Republic')
print("__________ITALY__________")
listas_concretas('Italy')
print("__________GERMANY__________")
listas_concretas('Germany')
print("__________CHINA__________")
